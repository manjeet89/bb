...
class Countrycontroller {
  static Future<List<CountryDropDownModel>> fetchLocations() async {
    var url = allapiscreen.country.toString();
    ...
    if (response.statusCode == 200) {
      ...
      return locations.map((e) => CountryDropDownModel.fromJson(e)).toList();
    } else {
